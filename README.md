...
# Setup:
1 Zu aller erst muss die kamera mit dem USB-A auf USB-C Kabel mit dem PC verbunden werden. Danach muss die Kamera eingeschalten werden (ein mal auf den einschalt Knopf Klicken)
...
2 Anschliesend muss der PC gestartet und das Programm OBS geöffnet werden. Die vorschau rechts oben sollte bereit ds Bild der Kamera zeigen.
# so wie hier
